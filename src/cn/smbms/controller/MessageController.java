...
import cn.smbms.pojo.MessageReply;
import cn.smbms.pojo.Reply;
import cn.smbms.pojo.User;
import cn.smbms.service.leavemessage.LeaveMessageService;
import cn.smbms.service.reply.ReplyService;
		...
		if(session.getAttribute(Constants.SESSION_BASE_MODEL) == null){
			...
			try {
				...
				if(null != addReply.getReplyContent() && !addReply.getReplyContent().equals("")){
					addReply.setReplyContent(addReply.getReplyContent());
				}
